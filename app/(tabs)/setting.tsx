...
export default function SettingScreen() {
    ...
    const clearCache = async () => {
        try {
            ...
            Alert.alert('Cache cleared', 'All cached products have been removed.');
        } catch (e) {
            ...
            <FlatList
                ListHeaderComponent={
                    <View>
                        ...
                        >
                            <Text style={styles.dropdownTitle}>Select Allergies</Text>
                            <Ionicons name={showAllergens ? 'chevron-up' : 'chevron-down'} size={20} />
                        </TouchableOpacity>
                        {showAllergens && (
                            <View>
                                {ALLERGENS.map(item => (
                ...
                ListFooterComponent={
                    <View>
                        ...
                        <TouchableOpacity
                            ...
                            onPress={clearCache}
                        >
                            <Text style={{ fontWeight: 'bold', color: '#333' }}>Clear cache</Text>
                        </TouchableOpacity>
                    </View>
                }
